...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(sumFinish:)
                                                 name:@"SumFinish" object:nil];
...
- (void)sumFinish : (NSNotification*) notification{
    _mainView.resultTxt.text = [NSString stringWithFormat:@"%d",[_model getSum] ] ;
}
